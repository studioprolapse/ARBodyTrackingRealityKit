...
enum Bones: CaseIterable {
  ...
  /// This property return compound name for the bone
  var name: String {
    return "\(jointFromName)-\(jointToName)"
  }
  
  /// This property return name of originating joint of the bone (fromJoint)
  ...
  /// This property return the destination joint of the bone (toJoint)
